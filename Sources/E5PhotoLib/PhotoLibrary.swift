...
open class PhotoLibrary{
    
    public static var defaultFileType: AVFileType = .jpg
    
    public static var albumName = ""
    
    public static  func initializeAlbum(albumName: String){
    ...
    public static func getAlbum() -> PHAssetCollection?{
    ...
    public static func savePhoto(photoData: Data, fileType: AVFileType?, location: CLLocation?, resultHandler: @escaping (String) -> Void){
        PHPhotoLibrary.requestAuthorization { status in
            if status == PHAuthorizationStatus.authorized {
    ...
    public static func saveVideo(outputFileURL: URL, location: CLLocation?, resultHandler: @escaping (String) -> Void){
        PHPhotoLibrary.requestAuthorization { status in
    ...
    public static func addToAlbum(localIdentifier: String){
        PHPhotoLibrary.requestAuthorization { status in
            if status == .authorized {
